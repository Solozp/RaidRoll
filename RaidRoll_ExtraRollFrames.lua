...
--------------------------------------------------------------
	...
	RR_RightFrame:SetWidth(105) -- Set these to whatever height/width is needed 
	RR_RightFrame:SetHeight(85) -- for your Texture
...
-- BidRise Buttons	
	RR_Bid_100 = CreateFrame("Button", "RR_Bid_100", RR_RightFrame, "UIPanelButtonTemplate")
	RR_Bid_100:SetWidth(40)
	RR_Bid_100:SetHeight(18)
	RR_Bid_100:SetPoint("TopLeft", RR_RightFrame, "TopLeft", 10, -10)
	RR_Bid_100:SetText("100")
	RR_Bid_100:SetScript("OnClick", function() BidRise(100, "b") end)

	RR_Bid_1k = CreateFrame("Button", "RR_Bid_1k", RR_RightFrame, "UIPanelButtonTemplate")
	RR_Bid_1k:SetWidth(40)
	RR_Bid_1k:SetHeight(18)
	RR_Bid_1k:SetPoint("Top", RR_Bid_100, "Bottom", 0, -5)
	RR_Bid_1k:SetText("1k")
	RR_Bid_1k:SetScript("OnClick", function() BidRise(1000, "b") end)
	
	RR_Bid_5k = CreateFrame("Button", "RR_Bid_5k", RR_RightFrame, "UIPanelButtonTemplate")
	RR_Bid_5k:SetWidth(40)
	RR_Bid_5k:SetHeight(18)
	RR_Bid_5k:SetPoint("Top", RR_Bid_1k, "Bottom", 0, -5)
	RR_Bid_5k:SetText("5k")
	RR_Bid_5k:SetScript("OnClick", function() BidRise(5000, "b") end)
	
	RR_Rise_100 = CreateFrame("Button", "RR_Rise_100", RR_RightFrame, "UIPanelButtonTemplate")
	RR_Rise_100:SetWidth(40)
	RR_Rise_100:SetHeight(18)
	RR_Rise_100:SetPoint("Left", RR_Bid_100, "Right", 5, 0)
	RR_Rise_100:SetText("+100")
	RR_Rise_100:SetScript("OnClick", function() BidRise(100, "r") end)

	RR_Rise_1k = CreateFrame("Button", "RR_Rise_1k", RR_RightFrame, "UIPanelButtonTemplate")
	RR_Rise_1k:SetWidth(40)
	RR_Rise_1k:SetHeight(18)
	RR_Rise_1k:SetPoint("Top", RR_Rise_100, "Bottom", 0, -5)
	RR_Rise_1k:SetText("+1k")
	RR_Rise_1k:SetScript("OnClick", function() BidRise(1000, "r") end)
	
	RR_Rise_5k = CreateFrame("Button", "RR_Bid_5k", RR_RightFrame, "UIPanelButtonTemplate")
	RR_Rise_5k:SetWidth(40)
	RR_Rise_5k:SetHeight(18)
	RR_Rise_5k:SetPoint("Top", RR_Rise_1k, "Bottom", 0, -5)
	RR_Rise_5k:SetText("+5k")
	RR_Rise_5k:SetScript("OnClick", function() BidRise(5000, "r") end)
...
-- Create 5 buttons to mark up names
	for i=1,5 do
		...
		Raid_Roll_SetSymbol.Left:Hide()
		Raid_Roll_SetSymbol.Right:Hide()
		Raid_Roll_SetSymbol.Middle:Hide()
...
-- -- bid and rise menu button
	...
	RR_BidRise:SetScript("OnClick", rollToggle)
